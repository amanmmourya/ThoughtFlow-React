...
const EnterGroup = () => {
  ...
  const handleEnterGroup = async () => {
    ...
    setIsLoading(true);
    const response=await fetch(`${VITE_BACKEND_URL}/api/group/entergroup`,{
        method:'POST',
        headers:{
            'Content-Type':'application/json'
        },
        body:JSON.stringify({groupIdentity})
    })
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-gray-900 border border-gray-700 rounded-2xl p-8 shadow-xl">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-white mb-2">Enter a Group</h1>
            <p className="text-gray-400 text-sm">Enter Group using group identity</p>
          </div>
          ...
          <div className="mt-6 p-4 bg-gray-800 rounded-xl">
            <p className="text-xs text-gray-400 text-center">
              Press Enter to navigate to group or click the button above
            </p>
          </div>
        </div>
      </div>
